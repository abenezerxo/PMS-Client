...
public class Form_V_In_Search_Detail extends javax.swing.JPanel {

    public Form_V_In_Search_Detail() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lbParkedSince = new javax.swing.JLabel();
        ...
        lbHeader.setText("P a r k e d  V e h i c l e");
        ...
        jPanel5.setLayout(new java.awt.GridLayout(3, 2, 20, 10));
        ...
        lblDriver17.setText("Parked Since");
        jPanel5.add(lblDriver17);

        lbParkedSince.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lbParkedSince.setText("8:AM 06-Feb-2024 (5hrs)");
        jPanel5.add(lbParkedSince);
    ...
    public static javax.swing.JLabel lbParkedSince;
